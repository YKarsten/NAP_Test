					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NAP Github Anbindung Test",
									"targetURL": "#naptest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"naptest-display": {
								"semanticObject": "naptest",
								"action": "display",
								"description": "Test Applikation um die git Versionskontrolle und Kollaboration zu testen",
								"title": "NAP Github Anbindung Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=naptest",
									"url": sap.ui.require.toUrl("naptest")
								}
							}
						}
					}
